...
<form action="process_adlog.php" method="post">
  <div class="imgcontainer">
    <img src="proggif.gif" alt="Avatar" class="avatar" style="width:200px; height:182px;">
  </div>
  <div>
    <p style="text-align: center; color: gold; font-size: 33; font-family: serif"><b>
      <u>IITS Programming Club</u>
    </b>
    </p>
  </div>
  <div class="container">
    <label style="color: white"><b>Username<br></b></label>
    <input type="text" placeholder="Enter Username" id="user" name="user" required/>
    <br>
    <label  style="color: white"><b>Password</b><br></label>
  ...
  <div class="container" >
    <a href="#">
    <button type="button" class="cancelbtn"><a href="member.html">Member</button>
    </a>
    <br>
  </div>
</form>
